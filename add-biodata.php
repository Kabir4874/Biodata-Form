...
$form_data = isset($_SESSION['add-biodata-data']) ? $_SESSION['add-biodata-data'] : [
  'fullName' => '',
  'nickname' => '',
  'dateOfBirth' => '',
  'age' => '',
...
<body>
  <div class="form-container">
    ...
    <form action="./logic/add-logic.php" method="POST" enctype="multipart/form-data">
      ...
      <button type="submit" name="submit" class="btn btn-primary">Submit Biodata</button>
